...
def aws() :
			while(True) :
				...
				press 3 : Create key-pair
				press 4 : Describe key-pair
				press 5 : Delete key-pair
				press 6 : Create security group
				press 7 : Describe security group
				press 8 : Delete security group
				press 9 : Launch new EC2 instance
				press 10: Start the stopped instance
				press 11: Stop an running instance
				press 12: View all running and stopped instances
				press 13: Launch new EBS volumn
				press 14: Attach EBS volumn to ec2 instance 
				press 15: View volumes 
				press 16: Delete volume 		
				press 17: Exit the AWS menu 
				""")
				os.system("tput setaf 7")
...
def docker():
	while(True) :
		...
		if op==1 :
			print("""
			press 1 : Enter filename of docker repo  
			press 2 : Want to create docker repo file
			""")
		...
		if op==10 :
			...
			print("""
			\t\t\tpress 1 : Stop all containers
			\t\t\tpress 2 : Stop a particular container	
			""")		
	
			op1=int(input("Enter your choice : \t"))

			if op1==1:		
				os.system("docker container stop 'docker ps -a'")		
			if op1==2:
